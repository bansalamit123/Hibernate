...
public class TestFirstLevel {
	public static void main(String[] args) {
		...
		/* session.evict(dto1); */
		  ...
		  System.out.print(dto2.getId()); System.out.print("\t" + dto2.getFirstName());
		  System.out.print("\t" + dto2.getLastName()); System.out.print("\t" +
		  dto2.getLogin()); System.out.print("\t" + dto2.getPassword());
		  System.out.print("\t" + dto2.getDob()); System.out.println("\t" +
		  dto2.getAddress());
